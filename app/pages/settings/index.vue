  ...
  >
    ...
    <UPageCard variant="subtle">
      ...
      <UFormField
        ...
        description="Votre nom d'utilisateur unique pour vous connecter et l'URL de votre profil."
        required
        class="flex max-sm:flex-col justify-between items-start gap-4"
      >
        <UInput
      ...
      <UFormField
        name="bio"
        label="Biographie"
        description="Brève description pour votre profil. Les URLs sont automatiquement liées."
        class="flex max-sm:flex-col justify-between items-start gap-4"
        :ui="{ container: 'w-full' }"
      >
        <UTextarea
