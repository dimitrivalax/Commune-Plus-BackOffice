...
<template>
  <UModal
    ...
    description="Ajouter une information générale envoyée à tous les utilisateurs"
  >
    <UButton label="Nouvelle notification" icon="i-lucide-bell-plus" />
