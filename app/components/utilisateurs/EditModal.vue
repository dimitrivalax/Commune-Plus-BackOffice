    ...
    <template #body>
      ...
      >
        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          <UFormField label="Ville" placeholder="Venerque" name="ville">
        ...
        <UFormField label="Communes associées" name="communes">
          <div
            class="space-y-2 max-h-48 overflow-y-auto border border-default rounded-lg p-3"
          >
            <div
              v-if="!communes || communes.length === 0"
