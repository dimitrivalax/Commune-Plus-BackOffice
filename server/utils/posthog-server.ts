  ...
  try {
    ...
    const detail
      = typeof error === 'object' && error !== null
        ? (error as { data?: { detail?: string, message?: string }, message?: string }).data?.detail
        || (error as { data?: { detail?: string, message?: string }, message?: string }).data?.message
        || (error as { data?: { detail?: string, message?: string }, message?: string }).message
        : undefined
